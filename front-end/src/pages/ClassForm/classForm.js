...
function ClassForm() {
  ...
  const isDetailMode = location.pathname.includes('detail');
   ...
   const { pageTitle } = useFormMode('/class/update','/class/detail' ,{
      ...
      if (isEditMode || isDetailMode) {
        try {
          ...
          setFormData({
            ...
            classSoTiet: res.data.data.classSoTiet !== null && res.data.data.classSoTiet !== undefined ? String(res.data.data.classSoTiet) : '',
            ...
            classKinhPhi: res.data.data.classKinhPhi !== null && res.data.data.classKinhPhi !== undefined ? String(res.data.data.classKinhPhi) : '',
    ...
    <section className="content">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <DataTable
          ...
          data={isDetailMode ? employees.filter((employee) => selectedEmployeeIds.includes(employee.id)) : employees}
          columnMap={labelMap}

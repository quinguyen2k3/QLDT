...
namespace QLDT.Service.impl
{
    public class TrainingUnitSerImpl : TrainingUnitSer
    {
        ...
        public async Task<TrainingUnitRes> CreateAsync(TrainingUnitReq req)
        {
            ...
            var entity = _mapper.Map<TrainingUnit>(req);
            ...
            return _mapper.Map<TrainingUnitRes>(created);
        }

        public async Task<TrainingUnitRes?> UpdateAsync(long id, TrainingUnitReq req)
        {
            var username = _httpContextAccessor.HttpContext?.User
                               .FindFirstValue(ClaimTypes.Name) ?? throw new UnauthorizedAccessException();
            ...
            return _mapper.Map<TrainingUnitRes>(updated);
        }
    }
}

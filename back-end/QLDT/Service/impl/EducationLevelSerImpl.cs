...
namespace QLDT.Service.impl
{
    public class EducationLevelSerImpl : EducationLevelSer
    {
        ...
        public async Task<EducationLevelRes> CreateAsync(EducationLevelReq req)
        {
            ...
            var entity = _mapper.Map<EducationLevel>(req);
            ...
            return _mapper.Map<EducationLevelRes>(created);
        }

        public async Task<EducationLevelRes?> UpdateAsync(long id, EducationLevelReq req)
        {
            var username = _httpContextAccessor.HttpContext?.User
                               .FindFirstValue(ClaimTypes.Name) ?? throw new UnauthorizedAccessException();
            ...
            return _mapper.Map<EducationLevelRes>(updated);
        }
    }
}
